    ...
    <div class="col-md-12">
        <div class="card border-success">
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-md-6">
                        <form class="form-horizontal p-t-20" action="{{ route('branch.store') }}" method="post">
                            @csrf
                                ...
                                <div class="col-sm-9">
                                    <div class="input-group">
                                        <select class="form-control select2" name="type" id="type">
                                            ...
                                            <option {{ (old('type')=="pos") ? 'selected':false }} value="pos">POS</option>
                                            <option {{ (old('type')=="mc") ? 'selected':false }} value="mc">Micro Credit</option>
                                        </select>
                                        @error('type')
