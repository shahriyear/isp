            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-md-6 offset-lg-3">
                        <form class="form-horizontal p-t-20" action="{{ route('isp.store')}}" method="POST">
                            @csrf
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <div class="input-group">
                                        <input id="lat" name="lat" type="text" class="form-control @error('lat') is-invalid @enderror" placeholder="Latitude" value="{{ old('lat')}}" />
                                        @error('lat')
                                        <span class="invalid-feedback" role="alert"> {{ $message }} </span>
                                        @enderror
                                    </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <div class="input-group">
                                        <input id="long" name="long" type="text" class="form-control @error('long') is-invalid @enderror" placeholder="Longitude" value="{{ old('long')}}" />
                                        @error('long')
                                        <span class="invalid-feedback" role="alert"> {{ $message }} </span>
                                        @enderror
                                    </div>
