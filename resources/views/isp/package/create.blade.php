            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-md-6 offset-lg-3">
                        <form class="form-horizontal p-t-20" action="{{ route('package.store')}}" method="POST">
                            @csrf
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <div class="input-group">
                                        <input id="price" name="price" type="text" class="form-control @error('price') is-invalid @enderror" placeholder="Price" value="{{ old('price')}}" />
